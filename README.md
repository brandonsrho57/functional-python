# Functional Python [![](https://github.com/brandonsrho57/functional-python/workflows/tests/badge.svg)](https://github.com/brandonsrho57/functional-python/actions?query=workflow%3Atests)
